...
import { apiResultFormat, subcategories } from '../../../../shared/model/page.model';
...
export class SubCategoriesComponent {
  ...
  public tableData: Array<subcategories> = [];
  public pageSize = 10;
  ...
  private getTableData(pageOption: pageSelection): void {
    this.data.getSubCategories().subscribe((apiRes: apiResultFormat) => {
      this.tableData = [];
      this.serialNumberArray = [];
      this.totalData = apiRes.totalData;
      apiRes.data.map((res: subcategories, index: number) => {
      ...
      this.dataSource = new MatTableDataSource<subcategories>(this.tableData);
