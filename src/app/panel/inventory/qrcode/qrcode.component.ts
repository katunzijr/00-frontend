...
import { apiResultFormat, qrCode } from '../../../shared/model/page.model';
...
export class QrcodeComponent {
  ...
  constructor(
    ...
    this.data.getDataTable().subscribe((apiRes: apiResultFormat) => {
      ...
      this.pagination.tablePageSize.subscribe((res: tablePageSize) => {
        if (this.router.url == InventoryRoutes.qrcode) {
  ...
  private getTableData(pageOption: pageSelection): void {
    this.data.getQrCode().subscribe((apiRes: apiResultFormat) => {
      this.tableData = [];
      this.serialNumberArray = [];
      this.totalData = apiRes.totalData;
      apiRes.data.map((res: qrCode, index: number) => {
      ...
      this.dataSource = new MatTableDataSource<qrCode>(this.tableData);
